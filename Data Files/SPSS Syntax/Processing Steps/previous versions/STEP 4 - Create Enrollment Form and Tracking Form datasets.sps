...
/*****************CREATE AND LABEL MENTAL HEALTH VARIABLES*****************/.

DATASET ACTIVATE MentalHealth.
RENAME VARIABLES (GAD7 = T_GAD7)
    (PHQ9 = T_PHQ9)
    (ModifiedMini = T_ModifiedMini)
    (PCPTSD = T_PCPTSD)
    (MI = T_MI)
    (SMI = T_SMI)
    (Schiz = T_Schiz)
...
RECODE T_GAD7 (0 thru 4=0) (5 thru 9=1) (10 thru 14=2) (15 thru 21=3) INTO T_GAD7_cat
    /T_PHQ9 (0 thru 4=0) (5 thru 9=1) (10 thru 14=2) (15 thru 19=3) (20 thru 27=4) INTO T_PHQ9_cat
    /T_PCPTSD (3 thru 5=1) (0 thru 2=0) INTO T_PTSD_cat
    /T_ModifiedMini (0 thru 6=1) (7 thru 9=2)(10 thru highest = 3)(sysmis=sysmis) INTO T_MMS_cat.
EXECUTE.
...
VALUE LABELS
T_MI to T_MI_Other 0 'No' 1 'Yes'
/T_GAD7_cat 0 'Minimal' 1 'Mild' 2 'Moderate' 3 'Severe' 
/T_PHQ9_cat 0 'Minimal' 1 'Mild' 2 'Moderate' 3 'Moderately Severe' 4 'Severe'
/T_PTSD_cat 0 'No PTSD' 1 'Yes PTSD'
/T_MMS_cat 1 'Low likelihood of MI' 2 'Moderate likelihood of MI' 3 'High likelihood of MI'.
...
VALUE LABELS T_CrimJustice T_SupportHouse T_SocialRehabProg 0 'No' 1'Yes'
/T_CJType 0 'Parolee' 1 'Probation' 2 'Drug Court'.

****************************************************************MERGE ENROLLMENT FORM SECTIONS****************************************************************/
...
RENAME VARIABLES (MI = T_MI) 
    ...
    (SocialRehabProg = T_SocialRehabProg)
    (Employ = T_Employ)
    (RatePerformance = T_RatePerformance)
    (CrimJustice = T_CrimJustice)
    (CJType1 = T_CJType)
    ...
    (MedTake = T_MedTake)
    (Smoking = T_Smoking)
    (CigNumber = T_CigNumber)
    (PHQ9 = T_PHQ9)
    (GAD7 = T_GAD7)
    (PCPTSD = T_PCPTSD)
    (PTSD_experiencedtrauma = T_PTSD_experiencedtrauma).


RECODE T_MedTake  (0=3)(1=2)(2=1)(3=0)
/T_MedFill (0=3)(1=2)(2=1)(3=0).
EXECUTE.
...
VALUE LABELS T_GAD7_cat 0 'Minimal' 1 'Mild' 2 'Moderate' 3 'Severe'
/T_PHQ9_cat 0 'Minimal' 1 'Mild' 2 'Moderate' 3 'Moderately Severe' 4 'Severe'
/T_PTSD_cat 0 'No' 1 'Yes'
/T_MI to T_Employ T_Medication T_Smoking 0 'No' 1 'Yes'
/T_RatePerformance 0 'Very Satisfactory' 1 'Satisfactory'
/T_CrimJustice 0 'No' 1'Yes'
/T_CJType 0 'Parolee' 1 'Probation' 2 'Drug Court'
/T_MedFill T_MedTake 3 'All of the Time' 2 'Most of the time' 1 'Sometimes' 0 'Never'.
...
GET DATA
  /TYPE=XLSX
  /FILE='\\casa.casacolumbia.org\Shares\Treatment\SAMHSA PIPBHC Secure\Additional Client Information Forms\Additional Client Information Form Spreadsheet.xlsx'
...
RECODE T_Multiple_SMI (0=0)(1=1)(2=1)(3=1) into T_SMI
    /T_GAD7 (0 thru 4=0) (5 thru 9=1) (10 thru 14=2) (15 thru 21=3) INTO T_GAD7_cat
    /T_PHQ9 (0 thru 4=0) (5 thru 9=1) (10 thru 14=2) (15 thru 19=3) (20 thru 27=4) INTO T_PHQ9_cat
    /T_PCPTSD (3 thru 5=1) (0 thru 2=0) INTO T_PTSD_cat
    /T_ModifiedMini (0 thru 6=1) (7 thru 9=2)(10 thru highest = 3)(sysmis=sysmis) INTO T_MMS_cat
    /T_ACE (0 =0) (1 thru 3=1) (4 thru 10=2)(sysmis=sysmis)   INTO T_ACE_cat.
EXECUTE.
...
*****************************************CREATE A VERSION OF ENROLLMENT DATA AT INTAKE*****************************************/
...
RENAME VARIABLES (T_CrimJustice = T_CrimJustice_intake)
    (T_CJType = T_CJType_intake)
    (T_SupportHouse = T_SupportHouse_intake)
    (T_SocialRehabProg = T_SocialRehabProg_intake)
    (T_GAD7 = T_GAD7_intake)
    (T_PHQ9 = T_PHQ9_intake)
    (T_ModifiedMini = T_ModifiedMini_intake)
    (T_PCPTSD = T_PCPTSD_intake)
    (T_ACE = T_ACE_intake)
    (T_MI = T_MI_intake)
    (T_SMI = T_SMI_intake)
    (T_Schiz = T_Schiz_intake)
    (T_Bipolar = T_Bipolar_intake)
    (T_MajDep = T_MajDep_intake)
    (T_Multiple_SMI = T_Multiple_SMI_intake)
    (T_GAD7_cat = T_GAD7_cat_intake)
    (T_PHQ9_cat = T_PHQ9_cat_intake)
    (T_PTSD_cat = T_PTSD_cat_intake)
    (T_MMS_cat = T_MMS_cat_intake)
    (T_ACE_cat = T_ACE_intake_cat)
    (T_MI_Other = T_MI_Other_intake)
    (T_OtherType = T_OtherType_intake)
    (ClientType = ClientType_intake)
    (T_JobTraining = T_JobTraining_intake)
    (T_Employ = T_Employ_intake)
    (T_RatePerformance = T_RatePerformance_intake)
    (T_Medication = T_Medication_intake)
    (T_MedTake = T_MedTake_intake).
...
*****************************************MERGE ADDITIONAL MEASURES/ENROLLMENT, FIND MISSING FORMS*****************************************/
...
T_Time 'Indicates how many times patient got a follow up with tracking form'.

VALUE LABELS  PrimaryLast 0 'Duplicate Case' 1 'Primary Case'
/T_Time 1 'Enrollment tracking form' 2 'First follow up' 3 'Second follow up' 4 'Third follow up'.
 EXECUTE.
...
RECODE T_GAD7_cat (0=0) (1=1) (2=1) (3=1) INTO T_GAD7_Bi
    /T_PHQ9_cat (0=0) (1=1) (2=1) (3=1) (4=1) INTO T_PHQ9_Bi
    /T_MMS_cat (1=0) (2=1) (3=1) INTO T_MMS_Bi
    /T_ACE_cat (0=0) (1=0) (2=1)(sysmis=sysmis) INTO T_ACE_Bi.
