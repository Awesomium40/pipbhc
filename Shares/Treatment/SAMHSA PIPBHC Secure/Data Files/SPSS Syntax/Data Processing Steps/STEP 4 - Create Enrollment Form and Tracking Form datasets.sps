...
GET DATA
    /TYPE=XLSX
    /FILE='acifFolder\Ramon Velez Forms\Enrollment Forms\Enrollment Form MH Data.xlsx'
    /SHEET=name 'Sheet1'
    /READNAMES=ON
...
*********************************RAMON VALEZ BASELINE FORMS, Additional Info****************************************
*********************************Enrollment form additional info*****************************************************************
********************************These get merged into the steps created above***********************************************

GET DATA
    /TYPE=XLSX
    /FILE='acifFolder\Ramon Velez Forms\Enrollment Forms\Enrollment Form Additional Information.xlsx'
...
/*Merging MentalHealth and AdditionalInformation into EnrollmentData, which represents all the Enrollment form data*/.
DATASET ACTIVATE AdditionalInformation.
...
GET DATA
    /TYPE=XLSX
    /FILE='acifFolder\Ramon Velez Forms\Tracking Forms\TIC Tracking Forms Data.xlsx'
    /SHEET=name 'Master'
    /READNAMES=ON
    /LEADINGSPACES IGNORE=YES
    /TRAILINGSPACES IGNORE=YES
...
/****There are some duplicates in this dataset that need to be removed. These are from clients who accidentally had forms entered twice****/.
...
DATASET ACTIVATE AdditionalMeasures.
SORT CASES BY Client_ID(A) T_Time(A) ClientType(A).
MATCH FILES
  /FILE=*
  /BY Client_ID T_Time ClientType
  /FIRST=PrimaryFirst
  /LAST=PrimaryLast.
DO IF (PrimaryFirst).
...
/****EnrollmentData represents Velez data, AdditionalMeasures represents Clay and Pagan data. These need to be merged together****/.
...
/****AdditionalMeasures has follow-up data as well, so need to remove that for this merge of BL data****/.
DATASET ACTIVATE AdditionalMeasures.
...
DATASET ACTIVATE enrollment_demographics.
RENAME VARIABLES
    (T_CrimJustice = T_CrimJustice_intake)
